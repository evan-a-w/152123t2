 ...
 * pacman.c
 *
 * Do NOT translate this file. You are required to translate `pacman.c`.
...
int get_direction(void) {
    ...
    while (TRUE) {
        ...
        if (input == EOF) {
            // This if statement does NOT need to be translated.
            // You should be translating pacman.c instead.
            exit(1);
        }
